...
const StartFunc = ({LocalCoumnITEMNAME,LocalCoumnITEMCATEGORY,LocalCoumnITEMGROUP,LocalCoumnGUID}) => {
  const LocalFileName = ParamsJson.TableName;
  const LocalDataPath = ParamsJson.DataPath;

  let LocalinDataToInsert = {ITEMNAME : LocalCoumnITEMNAME,ITEMCATEGORY : LocalCoumnITEMCATEGORY,ITEMGROUP : LocalCoumnITEMGROUP,GUID : LocalCoumnGUID};
